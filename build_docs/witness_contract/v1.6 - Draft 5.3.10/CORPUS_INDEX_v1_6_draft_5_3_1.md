...
- `refs/manifest/CHECKSUMS_v1_6_draft_5_3_1.sha256`
...
The 5.3.1 inventory, checksum file, human manifest, and validation report are generated artifacts excluded from their own recursive hash closure. Every other regular file is listed with size and SHA-256. The exclusion is explicit per record and is not a validation skip.
