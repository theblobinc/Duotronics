#!/usr/bin/env python3
"""Generate the complete lifecycle-classified Draft 5.3.10 schema registry."""
...
OUTPUT = ROOT / "refs/schema_registry_v1_6_draft_5_3_10.json"
...
CANONICAL = {
    ...
    "idempotency_cache_envelope_v2", "cache_signing_registry_v2", "domain_execution_evidence_v1",
...
LEGACY = {
    ...
    "idempotency_cache_envelope_v1", "cache_signing_registry_v1",
...
def main() -> int:
    ...
    for path in schema_paths:
        ...
        if name in CANONICAL:
            lifecycle = "canonical"; active = True; rationale = "Active Draft 5.3.10 API, persistence, witness, or validation surface."
        elif name in LEGACY:
        ...
        runtime_valid = {
            ...
            "idempotency_cache_envelope_v2": "runtime:test_cache_replay_rechecks_current_key_and_records_registry_evidence",
    ...
    registry = {
        ...
        "registry_version": "v1.6-draft-5.3.10", "active_version_scope": "v1.6-draft-5.3.10",
        "entries": entries,
        "rules": {
