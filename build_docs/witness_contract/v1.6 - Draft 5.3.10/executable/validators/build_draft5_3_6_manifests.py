...
CHECKSUMS = "refs/manifest/CHECKSUMS_v1_6_draft_5_3_6.sha256"
...
def main() -> int:
    ...
    records = []
    checksum_lines = [
        "# SHA-256 closure for Duotronic Witness Contract v1.6 Draft 5.3.6",
    ...
    inventory = {
        ...
        "historical_source_packages": [
            {"path": f"history/source_packages/{name}", "sha256": value, "file_count": count}
    ...
    manifest_lines.extend([
        ...
        "",
        "The active inventory, checksum file, this human manifest, and validation report describe package closure and therefore set only their own recursive `sha256` and `size_bytes` inventory fields to `null`. Each record names the excluded fields and reason. Every other final regular file is size- and SHA-256-covered.",
        "",
        "## Documentation scope",
        "",
