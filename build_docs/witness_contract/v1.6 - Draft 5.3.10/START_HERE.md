# Start Here — Duotronic Witness Contract v1.6 Draft 5.3.10

## Canonical boot

1. Load `CANONICAL_CORPUS_v1_6_draft_5_3_10.json` only.
2. Confirm `v1.6-draft-5.3.10`, the permanent-unfrozen lifecycle, and disabled authority defaults.
3. Verify `PACKAGE_INVENTORY_v1_6_draft_5_3_10.json` and `refs/manifest/CHECKSUMS_v1_6_draft_5_3_10.sha256`.
4. Load `refs/schema_registry_v1_6_draft_5_3_10.json`; unclassified schemas fail closed.
5. Read `duotronic_witness_contract_v1_6_draft_5_3_10.md` and `migration/draft5_3_9_to_draft5_3_10_migration_runbook.md`.
6. Run `python3 executable/validators/validate_draft5_3_10_corpus.py` and require every descriptor-required phase to pass.
...
- `schemas/cache_signing_registry_v1.schema.json`
- `schemas/domain_execution_evidence_v1.schema.json`
- `schemas/lean_compile_handoff_v2.schema.json`
- `executable/runtime/proof_check_service.py`
- `executable/runtime/proof_check_wsgi.py`
- `DRAFT5_3_10_REGRESSION_COUNTS.json`
- `DRAFT5_3_10_PYTHON_MATRIX_VALIDATION.json`
