...
3. Register `wc_sha256`, `wc_public_key_fingerprint`, `wc_ed25519_verify`, and `wc_is_canonical_json` from `executable/runtime/proof_authority.py` on the migration connection.
