...
snapshot identifier is content addressed as `sha256:<tree digest>`.
...
host accepts no result lacking a valid Ed25519 signature from the result key
...
oci_runtime_sha256 and oci_runtime_version
oci_image_digest
...
canonical, hash-bound, Ed25519-signed by a valid governance trust root, and
