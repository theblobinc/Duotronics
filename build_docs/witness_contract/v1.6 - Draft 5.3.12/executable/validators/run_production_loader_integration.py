...
def run_integration() -> dict:
    if os.geteuid() != 0:
        raise RuntimeError("production-shape chroot integration requires a root test launcher before setuid")
    with tempfile.TemporaryDirectory(prefix="witness-loader-chroot-") as directory:
        ...
        return {
            ...
            "execution_model": "chroot_then_setgid_setuid_actual_loaders",
