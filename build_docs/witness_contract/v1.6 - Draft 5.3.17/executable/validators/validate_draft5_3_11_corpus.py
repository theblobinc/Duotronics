...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_11.json", "CHECKSUMS_v1_6_draft_5_3_11.shake256_512"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_11.shake256_512").read_text(encoding="utf-8").splitlines()
...
def phase_python_version_portability() -> dict[str, Any]:
    ...
    assert_true(generated.get("python_matrix_shake256_512") == shake256_512(ROOT / "DRAFT5_3_11_PYTHON_MATRIX_VALIDATION.json"), "regression record does not bind the Python matrix")
    for item in runs:
...
def phase_standalone_merged_corpus() -> dict[str, Any]:
    ...
    assert_true(releases[-1].get("version") == "v1.6-draft-5.3.10" and releases[-1].get("shake256_512") == "6956ea0f5118b3a1bf6db02cf48385c85b298300de49f9e33f225e4d4f1564ba", "immediate predecessor lineage mismatch")
