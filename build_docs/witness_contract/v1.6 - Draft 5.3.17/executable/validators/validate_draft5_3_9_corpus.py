...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_9.json", "CHECKSUMS_v1_6_draft_5_3_9.shake256_512"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_9.shake256_512").read_text(encoding="utf-8").splitlines()
...
def phase_standalone_merged_corpus() -> dict[str, Any]:
    ...
    assert_true(releases[-1].get("version") == "v1.6-draft-5.3.8" and releases[-1].get("shake256_512") == "8abfc95444306d366fa492d987c57d7f9e7a2422f81b64a60c99681c9c563abf", "immediate predecessor lineage mismatch")
