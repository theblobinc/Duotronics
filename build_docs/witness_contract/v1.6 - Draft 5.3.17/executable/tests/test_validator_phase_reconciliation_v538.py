...
MODULE_PATH = ROOT / "executable/validators/validate_draft5_3_8_corpus.py"
SPEC = importlib.util.spec_from_file_location("validator_phase_reconciliation_v538", MODULE_PATH)
...
class ValidatorPhaseReconciliationV538Tests(unittest.TestCase):
