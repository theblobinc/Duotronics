...
MODULE_PATH = ROOT / "executable/validators/validate_draft5_3_9_corpus.py"
SPEC = importlib.util.spec_from_file_location("validator_phase_reconciliation_v539", MODULE_PATH)
...
class ValidatorPhaseReconciliationV539Tests(unittest.TestCase):
