...
Draft 5.3.10 incorporates the complete current corpus and supersedes Draft 5.3.8 on the governed-image, execution-evidence, request-lifecycle, cache-signing, persistence, schema, and validation surfaces listed by the canonical descriptor. Earlier source-package archives are not embedded.
