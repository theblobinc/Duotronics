# Duotronic Research Profile Gcd Jump Recurrences v1 0 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `refs/research_profiles/carried_forward/duotronic_research_profile_gcd_jump_recurrences_v1_0.md` from v1.5 Draft 2  
