# Duotronic Research Profile Qcd Spin Correlation Analogy v1 2 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `refs/research_profiles/carried_forward/duotronic_research_profile_qcd_spin_correlation_analogy_v1_2.md` from v1.5 Draft 2  
