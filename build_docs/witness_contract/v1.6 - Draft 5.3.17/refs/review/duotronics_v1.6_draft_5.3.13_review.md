...
| Check | Result |
|---|---:|
| Submitted ZIP SHAKE256-512 | `6b9229cd3d463053328bed84ce59585638b74bd6e2193667e48af6863305f733` |
| ZIP integrity | Passed |
| ZIP entries | 1,958 |
| Regular files / inventory records | 1,783 |
| Directory records | 175 ZIP directory entries |
| SHAKE256-512-covered files | 1,779 |
...
The four recursive exclusions are correctly represented with both `shake256_512` and `size_bytes` set to `null`:

1. `DRAFT5_3_13_VALIDATION_REPORT.json`
2. `PACKAGE_INVENTORY_v1_6_draft_5_3_13.json`
3. `refs/manifest/CHECKSUMS_v1_6_draft_5_3_13.shake256_512`
...
- the cache envelope’s `signed_payload_shake256_512`;
- a canonical full-envelope SHAKE256-512;
- the envelope signature.

`cache_envelope_id` is derived from request SHAKE256-512, principal, and compiler-witness signed-payload SHAKE256-512. It is not a digest of the complete signed envelope.
