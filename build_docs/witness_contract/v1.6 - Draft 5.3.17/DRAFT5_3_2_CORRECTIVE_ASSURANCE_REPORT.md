...
| Spoofed `lake` on PATH | PATH lookup forbidden; absolute executable and SHAKE256-512 pin required | PATH-spoof and wrong-digest tests |
...
| SQL trusted decorative signatures | Canonical payload bindings call ML-DSA-87 verification and compare every authority field | SQL cryptographic and tamper tests |
