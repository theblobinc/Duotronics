...
This file is normative for Duotronic Witness Contract v1.7 Draft 1.3 and supersedes any Draft 1 wording that treated knot theory as merely additive or second-class.
...
The v1.7 Draft 1.3 knot layer defines these first-class witness objects:
...
A v1.7 Draft 1.3 knot runtime MUST expose:
