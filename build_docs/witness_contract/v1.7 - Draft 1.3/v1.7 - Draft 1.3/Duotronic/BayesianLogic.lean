...
structure BayesianPosteriorPredictiveWitness where
  posteriorPredictiveWitnessId : String
  modelId : String
  posteriorId : String
  distributionNormalized : Bool
  deriving Repr

structure BayesianMarginalizationWitness where
  marginalizationWitnessId : String
  modelId : String
  resultNormalized : Bool
  deriving Repr

structure BayesianConditioningWitness where
  conditioningWitnessId : String
  modelId : String
  conditionProbabilityPositive : Bool
  deriving Repr

structure BayesianNegativeEvidenceWitness where
  negativeEvidenceWitnessId : String
  modelId : String
  handlingPolicy : String
  deriving Repr

structure BayesianLossMatrixWitness where
  lossMatrixId : String
  modelId : String
  hasHumanReviewThreshold : Bool
  deriving Repr
