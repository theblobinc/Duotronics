# Duotronic Witness Contract v10.14

**Status:** Research specification draft  
**Version:** 10.14-standalone-revision  
...
The owning document is `refs/duotronic_chronological_self_evidence_contract_v1_0.md`.
...
The owning document is `refs/duotronic_internal_decision_and_planning_contract_v1_0.md`.
...
The owning document is `refs/duotronic_lookup_memory_and_replay_profile_v1_0.md`.
