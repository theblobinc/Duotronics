# Duotronic Polygon Family Calculus (DPFC v5.14)

**Status:** Research specification draft  
**Version:** 5.14-standalone-revision  
...
DPFC v5.14 defines the mathematical and representational layer of Duotronics.
...
DPFC v5.14 does not claim that:
...
DPFC v5.14 adopts `refs/duotronic_glossary_v1_0.md` for shared terms.
...
DPFC v5.14 remains the representational core. Draft 3 adds self-evidence, lookup memory, planning, and model-diversity governance to the corpus, but those additions do not redefine DPFC arithmetic, family value, canonical family identity, export policy, or bridge semantics.
