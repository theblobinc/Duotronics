# Duotronic Search and Social Evidence Ingestion v1.2

**Status:** Source-spec baseline candidate  
**Version:** search-social-evidence-ingestion@v1.2  
...
A source ingestion adapter may emit a `PersonalHistorySourceRecord` or `ChronologicalEvidenceStream` reference. The owning contract is `duotronic_chronological_self_evidence_contract_v1_0.md`.
