...
1. `duotronic_chronological_self_evidence_contract_v1_0.md`
2. `duotronic_lookup_memory_and_replay_profile_v1_0.md`
3. `duotronic_internal_decision_and_planning_contract_v1_0.md`
4. `duotronic_model_diversity_and_adjudication_governance_v1_0.md`
