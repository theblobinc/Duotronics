...
class FakeTwoDomainRunner:
    ...
    def run(self, *, profile, snapshot_root, generated_module, request, timeout_seconds):
        ...
        forbidden: list[str] = []
        result = {
            "schema_version": "wc_lean_verifier_result/v4",
            "status": "passed",
            ...
            "accepted_controls": list(self.CONTROLS), "measured_controls": list(self.CONTROLS),
            "derived_controls": [], "control_evidence": [],
        ...
        if self.mode == "statement_mismatch":
            ...
            return authority.SandboxExecution(0, None, "fake canonical JSON", "", False, ("compile",), ("verify",), self.INVOCATION_HASH, self._security(), self.CONTROLS, self.CONTROLS, self.CONTROLS, normalized_executed_argv_sha256=self.ARGV_HASH)
