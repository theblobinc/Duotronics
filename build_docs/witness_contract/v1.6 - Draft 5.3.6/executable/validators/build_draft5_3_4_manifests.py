...
CHECKSUMS = "refs/manifest/CHECKSUMS_v1_6_draft_5_3_4.sha256"
...
def main() -> int:
    ...
    records = []
    checksum_lines = [
        "# SHA-256 closure for Duotronic Witness Contract v1.6 Draft 5.3.4",
    ...
    inventory = {
        ...
        "historical_source_packages": [
            ...
            {"path": "history/source_packages/v1.6 - Draft 5.3.3.zip", "sha256": "b02165cffa8b95b41a210f06b5e734e9592472a9c29630c07bb0ea318c7c3cb1", "file_count": 1238}
        ],
