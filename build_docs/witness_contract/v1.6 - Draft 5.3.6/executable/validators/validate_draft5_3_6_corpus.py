...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_6.json", "CHECKSUMS_v1_6_draft_5_3_6.sha256"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_6.sha256").read_text(encoding="utf-8").splitlines()
...
def phase_sql_v536_authority_closure() -> dict[str, Any]:
    ...
    for token in (
        ...
        "effective_resource_limits_sha256", "compile_handoff_manifest_sha256",
        "trust_root_attestation_registry_sha256", "wc_compiler_witness_v5_no_update",
