...
A source ingestion adapter may emit a `PersonalHistorySourceRecord` or `ChronologicalEvidenceStream` reference. The owning contract is `duotronic_chronological_self_evidence_contract_v1_1.md`.
