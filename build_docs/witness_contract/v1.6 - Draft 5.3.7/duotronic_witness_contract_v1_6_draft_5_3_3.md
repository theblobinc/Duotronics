...
generated_witness_module_sha256
...
`compiler_executable_sha256` field equals the actual Lean executable digest; it
...
payload hash, and signature. SQL verifies canonical JSON, Ed25519 signature,
