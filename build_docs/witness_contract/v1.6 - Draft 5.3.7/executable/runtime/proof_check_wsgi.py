#!/usr/bin/env python3
"""Minimal synchronous WSGI adapter for the canonical proof-check operation."""
...
class ProofCheckWSGI:
    ...
    def __call__(self, environ: dict, start_response: Callable) -> Iterable[bytes]:
        ...
        try:
            ...
            status = "403 Forbidden" if error.code == "policy_decision_invalid" else "422 Unprocessable Entity"
