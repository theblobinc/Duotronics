#!/usr/bin/env python3
"""Generate the complete lifecycle-classified Draft 5.3.7 schema registry."""
...
OUTPUT = ROOT / "refs/schema_registry_v1_6_draft_5_3_7.json"
...
CANONICAL = {
    ...
    "effective_sandbox_invocation_v4", "lean_verifier_request_v4", "lean_inspector_result_v1", "lean_compile_handoff_v2",
    "lean_verifier_result_v5", "lean_compiler_witness_v6", "proof_check_request_v1", "proof_check_result_v5",
...
LEGACY = {
    ...
    "proof_check_result_v3", "proof_check_result_v4", "build_attestation_v1", "evidence_claim", "proof_witness",
...
def main() -> int:
    ...
    for path in schema_paths:
        ...
        if name in CANONICAL:
            lifecycle = "canonical"; active = True; rationale = "Active Draft 5.3.7 API, persistence, witness, or validation surface."
        elif name in LEGACY:
        ...
        runtime_valid = {
            "lean_verifier_result_v5": "runtime:test_signed_verifier_result_schema_boundary",
            "lean_compiler_witness_v6": "runtime:test_compiler_witness_schema_boundary",
            "proof_check_result_v5": "runtime:test_openapi_proof_check_response_matches_application",
        }
    ...
    registry = {
        ...
        "registry_version": "v1.6-draft-5.3.7", "active_version_scope": "v1.6-draft-5.3.7",
        "entries": entries,
        "rules": {
