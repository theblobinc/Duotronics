...
def main() -> int:
    ...
    unsigned = {
        "schema_version": "wc_lean_verifier_result/v5", "status": status,
        ...
        # Reaching this trusted entrypoint establishes that the runtime accepted
        # the emitted configuration.  Application is still classified only
        # from observations below.
        "accepted_controls": sorted(invocation["emitted_controls"]),
