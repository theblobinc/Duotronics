Draft 5.2.1 note: use `DRAFT5_2_1_LEAN_PROOF_AUTHORITY_UPDATE_REPORT_v1_0.md` and `kernel/lean_proof_authority_contract_v1_0.md` for the added Lean proof-authority layer.
