#!/usr/bin/env python3
"""Generate the complete lifecycle-classified Draft 5.3.13 schema registry."""
...
OUTPUT = ROOT / "refs/schema_registry_v1_6_draft_5_3_13.json"
...
CANONICAL = {
    ...
    "cache_stale_row_evidence_v3", "cache_audit_record_v1", "domain_execution_evidence_v1",
...
def main() -> int:
    ...
    for path in schema_paths:
        ...
        if name in CANONICAL:
            lifecycle = "canonical"; active = True; rationale = "Active Draft 5.3.13 API, persistence, witness, or validation surface."
        elif name in LEGACY:
        ...
        runtime_valid = {
            ...
            "cache_stale_row_evidence_v3": "runtime:test_authenticated_predecessor_row_emits_evidence_then_returns_stable_conflict",
            "cache_audit_record_v1": "runtime:test_signed_append_only_chain_is_durable_and_startup_verified",
    ...
    registry = {
        ...
        "registry_version": "v1.6-draft-5.3.13", "active_version_scope": "v1.6-draft-5.3.13",
        "entries": entries,
        "rules": {
