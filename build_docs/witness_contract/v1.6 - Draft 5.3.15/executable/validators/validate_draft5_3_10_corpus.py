...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_10.json", "CHECKSUMS_v1_6_draft_5_3_10.sha256"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_10.sha256").read_text(encoding="utf-8").splitlines()
...
def phase_standalone_merged_corpus() -> dict[str, Any]:
    ...
    assert_true(releases[-1].get("version") == "v1.6-draft-5.3.9" and releases[-1].get("sha256") == "93a8bcb6bf6b9ccf50363c28b352fc19358ea378e3938ccd4a492e87e11a7c79", "immediate predecessor lineage mismatch")
