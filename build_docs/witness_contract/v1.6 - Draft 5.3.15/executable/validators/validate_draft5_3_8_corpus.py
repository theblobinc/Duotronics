...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_8.json", "CHECKSUMS_v1_6_draft_5_3_8.sha256"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_8.sha256").read_text(encoding="utf-8").splitlines()
...
def phase_standalone_merged_corpus() -> dict[str, Any]:
    ...
    assert_true(releases[-1].get("version") == "v1.6-draft-5.3.7" and releases[-1].get("sha256") == "ba728768f5f1375654efb805856d1f02c187aeca0f60b8442b3a55170db61206", "immediate predecessor lineage mismatch")
