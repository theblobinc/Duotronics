...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_3.json", "CHECKSUMS_v1_6_draft_5_3_3.sha256"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_3.sha256").read_text(encoding="utf-8").splitlines()
...
def phase_sql_migration() -> dict[str, Any]:
    ...
    hardening = (
        "original_source_tree_sha256", "immutable_snapshot_sha256", "compiler_profile_id",
        "compiler_registry_sha256", "lake_executable_sha256", "lean_executable_sha256",
        "lean_stdlib_tree_sha256", "dependency_closure_sha256", "execution_image_digest",
        "sandbox_policy_sha256", "verifier_binary_sha256", "structured_result_sha256",
