...
ACTIVE_SCHEMA_FILES = {
    ...
    "cache_audit_anchor_state": "cache_audit_anchor_state_v1.schema.json",
    ...
    "cache_audit_recovery_authorization": "cache_audit_recovery_authorization_v1.schema.json",
    "cache_audit_recovery_evidence": "cache_audit_recovery_evidence_v1.schema.json",
    "cache_audit_publication_receipt": "cache_audit_publication_receipt_v1.schema.json",
...
def load_production_authority_service(config_root: Path = Path("/etc/witness-authority")) -> ProofAuthorityService:
    ...
    allowed = {
        ...
        "cache_audit_publisher_socket", "cache_audit_publisher_uid",
    }
