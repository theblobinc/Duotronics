...
MODULE_PATH = ROOT / "executable/validators/validate_draft5_3_7_corpus.py"
SPEC = importlib.util.spec_from_file_location("validator_phase_reconciliation_v537", MODULE_PATH)
...
class ValidatorPhaseReconciliationV537Tests(unittest.TestCase):
