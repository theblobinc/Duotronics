# Duotronic Schema Registry v1 10 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `refs/duotronic_schema_registry_v1_10.md` from v1.5 Draft 2  
...
The schema registry upgrades to include math-domain object envelopes, Langlands object envelopes, interpreter-run envelopes, theorem/conjecture status envelopes, temporal meta objects, and oracle identity adapter result shapes.
