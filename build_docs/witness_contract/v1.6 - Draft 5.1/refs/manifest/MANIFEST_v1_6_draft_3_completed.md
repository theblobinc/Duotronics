# Manifest — Duotronic v1.6 Draft 3 Completed

Status: manifest.

```yaml
bundle_id: duotronic_v1_6_draft_3_completed_corpus
version: v1.6-draft-3-completed
format: markdown
manifest_directory: refs/manifest
generated: 2026-04-30
markdown_file_count: 175
source_refresh_commits:
  - 44ec052
  - 88550ad
  - c5ff886
  - ef84215
  ...
  - 475f9a6
normative_updates:
  - TemporalWitness required for replay identity
  - AbsenceWitness required for missed ticks
  - MemoryUpdateRecord required for L2 ticks
  - DecayIntentWitness required for decay proposals
  - MCP target tools separated from verified tools
  - Stale ephemeral evidence quarantines
  - Stale slow-changing evidence degrades authority
  - Manifest documents stored under refs/manifest
  - WGRNN Firehose documented as observation UI, not truth authority
files:
  ...
  - duotronic_direct_mutation_tools_security_addendum_v1_0.md
