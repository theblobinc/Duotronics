...
| Check | Result |
|---|---:|
| Submitted ZIP SHA-256 | `f33d2c682afe312668c9d6256da59784a43cd91b29b73881109690b2709ce800` |
| ZIP integrity | Passed |
| ZIP entries | 2,101 |
| Regular files / inventory records | 1,915 |
| SHA-256-covered files | 1,911 |
...
The four recursive exclusions are correctly represented with `sha256: null` and `size_bytes: null`:

1. `DRAFT5_3_15_VALIDATION_REPORT.json`
2. `PACKAGE_INVENTORY_v1_6_draft_5_3_15.json`
3. `refs/manifest/CHECKSUMS_v1_6_draft_5_3_15.sha256`
...
```text
SHA-256(canonical supplied terminal record)
    == predecessor_checkpoint.tail_record_sha256
    == current_anchor.tail_record_sha256
```
...
- canonical terminal-record SHA-256 equals the checkpoint and anchor tail;
