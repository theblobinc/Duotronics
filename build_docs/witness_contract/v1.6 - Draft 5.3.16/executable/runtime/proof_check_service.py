...
def load_production_application(config_root: Path = Path("/etc/witness-authority")) -> ProofCheckApplication:
    ...
    receipt_registry_sha256, receipt_records, receipt_verification_keys = validate_governed_signing_registry(
    ...
    receipt_validity = key_validity_evidence(
        registry_sha256=receipt_registry_sha256, record=receipt_record, evaluated_at=now,
    )
    ...
    audit_sink = UnixSocketAuditPublisherClient(
        ...
        receipt_signing_registry_sha256=receipt_registry_sha256,
