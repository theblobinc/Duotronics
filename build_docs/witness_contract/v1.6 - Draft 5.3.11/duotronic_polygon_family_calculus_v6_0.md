# Duotronic Polygon Family Calculus v5 15 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `duotronic_polygon_family_calculus_v5_15.md` from v1.5 Draft 2  
**Version:** v1.6-draft-2 compatibility rewrite  
...
DPFC is retained for replay compatibility and for family-native representation discipline. It is no longer the exclusive mathematical core. In v1.6, its positive/presence-first semantics are embedded as one representational discipline inside the broader Mathematical Canon. Polygon-family research remains a carried-forward research domain, not the authority for all mathematics.
