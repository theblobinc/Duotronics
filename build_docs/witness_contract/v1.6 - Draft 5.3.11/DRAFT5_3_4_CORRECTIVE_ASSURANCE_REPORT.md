...
| Final result is trusted | private `0700` directory; exclusive/no-follow `0600` publication; Ed25519 result signature | symlink, hard-link, oversize, canonicalization, signer tests |
