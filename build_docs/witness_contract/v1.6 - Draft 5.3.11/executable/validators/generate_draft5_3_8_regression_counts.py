...
VALIDATOR = ROOT / "executable/validators/validate_draft5_3_8_corpus.py"
SPEC = importlib.util.spec_from_file_location("draft538_validator_counts", VALIDATOR)
...
def main() -> int:
    ...
    record = {
        "schema_version": "draft5_3_8_regression_counts/v1",
        "package_version": "v1.6-draft-5.3.8",
        "generated_at": datetime.now(timezone.utc).isoformat(),
        "draft5_3_7_baseline_tests_discovered": 154,
    ...
    (ROOT / "DRAFT5_3_8_REGRESSION_COUNTS.json").write_text(
        json.dumps(record, indent=2, sort_keys=True) + "\n", encoding="utf-8"
    )
    summary = "\n".join([
        "Duotronic Witness Contract v1.6 Draft 5.3.8 — Generated Validation Summary",
        ...
        "Draft 5.3.7 baseline: 154 tests discovered",
    ...
    (ROOT / "DRAFT5_3_8_VALIDATION_SUMMARY.txt").write_text(summary, encoding="utf-8")
