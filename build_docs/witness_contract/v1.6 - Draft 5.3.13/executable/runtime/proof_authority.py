#!/usr/bin/env python3
"""Fail-closed Lean proof authority for Witness Contract Draft 5.3.13.
...
ACTIVE_SCHEMA_FILES = {
    ...
    "cache_stale_row_evidence": "cache_stale_row_evidence_v3.schema.json",
    "cache_audit_record": "cache_audit_record_v1.schema.json",
...
ERROR_CODES = frozenset({
    ...
    "cache_key_rotation_requires_new_idempotency_key", "cache_audit_publication_failed",
})
