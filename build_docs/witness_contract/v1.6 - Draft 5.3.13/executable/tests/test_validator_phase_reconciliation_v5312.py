...
MODULE_PATH = ROOT / "executable/validators/validate_draft5_3_12_corpus.py"
SPEC = importlib.util.spec_from_file_location("validator_phase_reconciliation_v5312", MODULE_PATH)
...
class ValidatorPhaseReconciliationV5312Tests(unittest.TestCase):
