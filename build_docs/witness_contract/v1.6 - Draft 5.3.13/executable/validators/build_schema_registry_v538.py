#!/usr/bin/env python3
"""Generate the complete lifecycle-classified Draft 5.3.8 schema registry."""
...
OUTPUT = ROOT / "refs/schema_registry_v1_6_draft_5_3_8.json"
...
def main() -> int:
    ...
    for path in schema_paths:
        ...
        if name in CANONICAL:
            lifecycle = "canonical"; active = True; rationale = "Active Draft 5.3.8 API, persistence, witness, or validation surface."
        elif name in LEGACY:
    ...
    registry = {
        ...
        "registry_version": "v1.6-draft-5.3.8", "active_version_scope": "v1.6-draft-5.3.8",
        "entries": entries,
        "rules": {
