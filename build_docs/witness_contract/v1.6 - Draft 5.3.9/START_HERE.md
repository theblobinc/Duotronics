# Start Here — Duotronic Witness Contract v1.6 Draft 5.3.9

## Canonical boot

1. Load `CANONICAL_CORPUS_v1_6_draft_5_3_9.json` only.
2. Confirm `v1.6-draft-5.3.9`, the permanent-unfrozen lifecycle, and disabled authority defaults.
3. Verify `PACKAGE_INVENTORY_v1_6_draft_5_3_9.json` and `refs/manifest/CHECKSUMS_v1_6_draft_5_3_9.sha256`.
4. Load `refs/schema_registry_v1_6_draft_5_3_9.json`; unclassified schemas fail closed.
5. Read `duotronic_witness_contract_v1_6_draft_5_3_9.md` and `migration/draft5_3_8_to_draft5_3_9_migration_runbook.md`.
6. Run `python3 executable/validators/validate_draft5_3_9_corpus.py` and require every descriptor-required phase to pass.
...
- `DRAFT5_3_9_REGRESSION_COUNTS.json`
- `DRAFT5_3_9_PYTHON_MATRIX_VALIDATION.json`
