#!/usr/bin/env python3
"""Fail-closed Lean proof authority for Witness Contract Draft 5.3.9.
...
ACTIVE_SCHEMA_FILES = {
    ...
    "compiler_witness": "lean_compiler_witness_v7.schema.json",
    "proof_check_request": "proof_check_request_v2.schema.json",
    "proof_check_result": "proof_check_result_v6.schema.json",
    "idempotency_cache_envelope": "idempotency_cache_envelope_v1.schema.json",
    "cache_signing_registry": "cache_signing_registry_v1.schema.json",
...
class ProofAuthorityService:
    ...
    def verify(
        ...
        unsigned = {
            "schema_version": "lean_compiler_witness/v7", "lean_compiler_witness_id": "lean:" + sha256_bytes(canonical_bytes(semantic))[:32],
...
def load_production_authority_service(config_root: Path = Path("/etc/witness-authority")) -> ProofAuthorityService:
    ...
    allowed = {
        ...
        "cache_private_key_file", "cache_public_key_file", "cache_signing_registry_file",
