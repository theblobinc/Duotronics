# Duotronic Container Deployment And Node Lifecycle Reference v1 0 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `refs/duotronic_container_deployment_and_node_lifecycle_reference_v1_0.md` from v1.5 Draft 2  
