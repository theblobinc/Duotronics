# Duotronic Research Profile Selective Witness State Spaces v1 0 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `refs/research_profiles/carried_forward/duotronic_research_profile_selective_witness_state_spaces_v1_0.md` from v1.5 Draft 2  
