#!/usr/bin/env python3
"""Behavioral regressions for the Draft 5.3.8 corrective boundary."""
...
AUTH_SPEC = importlib.util.spec_from_file_location(
    "proof_authority_tests_538", RUNTIME / "proof_authority.py"
)
...
VERIFY_SPEC = importlib.util.spec_from_file_location(
    "verify_lean_tests_538", TRUSTED / "verify_lean.py"
)
...
VALIDATOR_SPEC = importlib.util.spec_from_file_location(
    "validate_draft538_tests", ROOT / "executable/validators/validate_draft5_3_8_corpus.py"
)
...
def profile_record(result_key: MLDSA87PrivateKey, runtime_hash: str) -> dict:
    return {
        ...
        "oci_runtime_shake256_512": runtime_hash,
...
class Draft538SandboxTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.result_key = MLDSA87PrivateKey.generate()
        runtime_hash = authority.shake256_512_file(self.runtime)
        ...
        self.runner = authority.OciSandboxRunner(
            ...
            expected_seccomp_profile_shake256_512=authority.shake256_512_file(self.seccomp),
    ...
    def test_rlimit_fsize_is_bound_into_invocation_digest(self):
        ...
        self.assertNotEqual(base.shake256_512, changed.shake256_512)
        self.assertNotEqual(
            base.as_dict()["normalized_executed_argv_shake256_512"],
            changed.as_dict()["normalized_executed_argv_shake256_512"],
        )
...
class Draft538RuntimeInspectionTests(unittest.TestCase):
...
class Draft538ValidationMetadataTests(unittest.TestCase):
    @staticmethod
