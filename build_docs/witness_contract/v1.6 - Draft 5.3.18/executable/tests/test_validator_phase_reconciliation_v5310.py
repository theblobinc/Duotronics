...
MODULE_PATH = ROOT / "executable/validators/validate_draft5_3_10_corpus.py"
SPEC = importlib.util.spec_from_file_location("validator_phase_reconciliation_v5310", MODULE_PATH)
...
class ValidatorPhaseReconciliationV5310Tests(unittest.TestCase):
