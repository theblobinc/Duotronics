#!/usr/bin/env python3
"""Build final-byte provenance, inventory, checksum, and manifest for Draft 5.3.13."""
...
INVENTORY = "PACKAGE_INVENTORY_v1_6_draft_5_3_13.json"
CHECKSUMS = "refs/manifest/CHECKSUMS_v1_6_draft_5_3_13.shake256_512"
MANIFEST = "refs/manifest/MANIFEST_v1_6_draft_5_3_13_complete.md"
REPORT = "DRAFT5_3_13_VALIDATION_REPORT.json"
PROVENANCE = "PACKAGE_PROVENANCE_v1_6_draft_5_3_13.json"
REVIEW = "refs/review/v1.6_draft_5.3.13_update_checklist.md"
...
def write_provenance() -> None:
    ...
    record = {
        ...
        "generator_version": "draft5_3_13_manifest_builder/v1",
        "generator_shake256_512": digest(ROOT / generator),
        "source_generation": "v1.6-draft-5.3.12",
        "base_revision": "v1.6-draft-5.3.12",
...
def main() -> int:
    ...
    records: list[dict] = []
    checksums = [
        "# SHAKE256-512 closure for Duotronic Witness Contract v1.6 Draft 5.3.13",
    ...
    inventory = {
        ...
        "package_version": "v1.6-draft-5.3.13",
        "package": "duotronic-witness-contract-v1.6-draft-5.3.13",
        ...
        "lineage_record": "history/SOURCE_PACKAGE_LINEAGE_v1_6_draft_5_3_13.json",
        ...
        "canonical_descriptor": "CANONICAL_CORPUS_v1_6_draft_5_3_13.json",
    ...
    lines = [
        "# Complete Manifest — Duotronic Witness Contract v1.6 Draft 5.3.13",
        "",
