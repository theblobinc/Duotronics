...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_16.json", "CHECKSUMS_v1_6_draft_5_3_16.shake256_512"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_16.shake256_512").read_text(encoding="utf-8").splitlines()
...
def phase_python_version_portability() -> dict[str, Any]:
    ...
    assert_true(generated.get("python_matrix_shake256_512") == shake256_512(ROOT / "DRAFT5_3_16_PYTHON_MATRIX_VALIDATION.json"), "regression record does not bind the Python matrix")
    for item in runs:
...
def phase_standalone_merged_corpus() -> dict[str, Any]:
    ...
    assert_true(
        ...
        and releases[-1].get("shake256_512") == "f33d2c682afe312668c9d6256da59784a43cd91b29b73881109690b2709ce800",
...
def phase_complete_stale_evidence_bindings() -> dict[str, Any]:
    ...
    expected = {
        ...
        "cache_envelope_signed_payload_shake256_512", "cache_envelope_canonical_shake256_512",
