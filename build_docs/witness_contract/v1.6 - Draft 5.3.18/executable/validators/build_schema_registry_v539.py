#!/usr/bin/env python3
"""Generate the complete lifecycle-classified Draft 5.3.9 schema registry."""
...
OUTPUT = ROOT / "refs/schema_registry_v1_6_draft_5_3_9.json"
...
CANONICAL = {
    ...
    "effective_sandbox_invocation_v5", "lean_verifier_request_v5", "lean_inspector_result_v1", "lean_compile_handoff_v2",
    "lean_verifier_result_v6", "lean_compiler_witness_v7", "proof_check_request_v2", "proof_check_result_v6",
    "idempotency_cache_envelope_v1", "cache_signing_registry_v1", "domain_execution_evidence_v1",
...
def main() -> int:
    ...
    for path in schema_paths:
        ...
        if name in CANONICAL:
            lifecycle = "canonical"; active = True; rationale = "Active Draft 5.3.9 API, persistence, witness, or validation surface."
        elif name in LEGACY:
        ...
        runtime_valid = {
            ...
            "lean_compiler_witness_v7": "runtime:test_compiler_witness_schema_boundary",
            "proof_check_request_v2": "runtime:test_authenticated_proof_check_request_schema_boundary",
            "proof_check_result_v6": "runtime:test_openapi_proof_check_response_matches_application",
            "idempotency_cache_envelope_v1": "runtime:test_cache_hit_revalidates_policy_witness_signature_and_all_bindings",
            "cache_signing_registry_v1": "runtime:test_production_cache_registry_authorization",
    ...
    registry = {
        ...
        "registry_version": "v1.6-draft-5.3.9", "active_version_scope": "v1.6-draft-5.3.9",
        "entries": entries,
        "rules": {
