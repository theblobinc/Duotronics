...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_12.json", "CHECKSUMS_v1_6_draft_5_3_12.shake256_512"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_12.shake256_512").read_text(encoding="utf-8").splitlines()
...
def phase_python_version_portability() -> dict[str, Any]:
    ...
    assert_true(generated.get("python_matrix_shake256_512") == shake256_512(ROOT / "DRAFT5_3_12_PYTHON_MATRIX_VALIDATION.json"), "regression record does not bind the Python matrix")
    for item in runs:
...
def phase_standalone_merged_corpus() -> dict[str, Any]:
    ...
    assert_true(
        ...
        and releases[-1].get("shake256_512") == "f1643c2f1a9cb4902d3685b87056548ddd8677278d7db4169e03fe82d03c62bc",
