# Corpus Index — v1.6 Draft 5.3.12

The canonical entry point is `CANONICAL_CORPUS_v1_6_draft_5_3_12.json`.

- Contract: `duotronic_witness_contract_v1_6_draft_5_3_12.md`
...
- Active cache schemas: envelope v3, cache-signing registry v2, signed registry-lineage v1, and stale-row evidence v2
...
- Service migration: `migration/draft5_3_11_to_draft5_3_12_migration_runbook.md`
- Formal model: `formal/draft5_3_7/ProofAuthorityV8.tla`
- Validator: `executable/validators/validate_draft5_3_12_corpus.py`
- Python evidence generator: `executable/validators/generate_draft5_3_12_python_evidence.py`
- Production-loader integration: `executable/validators/run_production_loader_integration.py`
- Generated counts: `DRAFT5_3_12_REGRESSION_COUNTS.json`
- Release notes: `RELEASE_NOTES_v1_6_draft_5_3_12.md`
- Predecessor digest lineage: `history/SOURCE_PACKAGE_LINEAGE_v1_6_draft_5_3_12.json`
