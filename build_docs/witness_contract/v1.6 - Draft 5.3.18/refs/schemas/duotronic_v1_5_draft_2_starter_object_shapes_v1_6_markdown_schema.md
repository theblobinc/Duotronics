# Duotronic v1 5 Draft 2 Starter Object Shapes — v1.6 Markdown schema appendix

**Status:** carried-forward schema/manifest record  
**v1.5 source path:** `refs/schemas/duotronic_v1_5_draft_2_starter_object_shapes.json`  
**v1.6 path:** `refs/schemas/duotronic_v1_5_draft_2_starter_object_shapes_v1_6_markdown_schema.md`

The v1.5 corpus contained this object as JSON. The v1.6 Markdown-only corpus keeps the schema or manifest as a Markdown appendix and treats machine-readable JSON regeneration as a build artifact.
...
A conforming implementation may regenerate a JSON form from this Markdown appendix only if the generated file includes:
...
4. content hash;
5. replay identity;
6. migration record from the v1.5 JSON shape.
