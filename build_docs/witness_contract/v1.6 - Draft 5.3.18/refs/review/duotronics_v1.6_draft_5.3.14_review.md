...
| Check | Result |
|---|---:|
| Submitted ZIP SHAKE256-512 | `625126b9e223f08c0cbf9faf0895d6b6d61077a63bdf606d57d5bb45c89c7a2a` |
| ZIP integrity | Passed |
| ZIP entries | 2,018 |
| Regular files / inventory records | 1,838 |
| Directory entries | 180 |
| SHAKE256-512-covered files | 1,834 |
...
The four recursive exclusions are correct and carry both `shake256_512: null` and `size_bytes: null`:

1. `DRAFT5_3_14_VALIDATION_REPORT.json`
2. `PACKAGE_INVENTORY_v1_6_draft_5_3_14.json`
3. `refs/manifest/CHECKSUMS_v1_6_draft_5_3_14.shake256_512`
...
Removing the current registry and running that command reproduced the packaged registry SHAKE256-512 exactly.
...
`previous_sealed_segment_tail_shake256_512` is accepted when it is any lowercase 64-hex value:
...
```text
previous_sealed_segment_tail_shake256_512 =
