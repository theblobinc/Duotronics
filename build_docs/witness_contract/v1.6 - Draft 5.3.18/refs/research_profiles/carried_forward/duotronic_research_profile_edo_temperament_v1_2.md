# Duotronic Research Profile Edo Temperament v1 2 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `refs/research_profiles/carried_forward/duotronic_research_profile_edo_temperament_v1_2.md` from v1.5 Draft 2  
