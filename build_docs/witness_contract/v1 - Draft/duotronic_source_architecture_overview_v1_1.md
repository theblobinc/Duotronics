# Duotronic Source Architecture Overview v1.1

**Status:** Internal source architecture draft  
**Version:** 1.1-source-overview  
...
The v1.1 overview keeps the v1.0 architecture map and adds review-polish changes: single-primary status tags, explicit source-corpus status values, and clearer distinction between existing documents, draft-needed documents, and future research profiles.
