...
ACTIVE_SCHEMA_FILES = {
    ...
    "cache_audit_record": "cache_audit_record_v2.schema.json",
    "cache_audit_checkpoint": "cache_audit_checkpoint_v1.schema.json",
    "cache_audit_segment_seal": "cache_audit_segment_seal_v1.schema.json",
...
ERROR_CODES = frozenset({
    ...
    "cache_key_rotation_requires_new_idempotency_key", "cache_audit_publication_failed", "cache_audit_integrity_invalid",
})
...
def load_production_authority_service(config_root: Path = Path("/etc/witness-authority")) -> ProofAuthorityService:
    ...
    allowed = {
        ...
        "cache_audit_private_key_file", "cache_audit_public_key_file", "cache_audit_log_file",
        "cache_audit_checkpoint_file", "cache_audit_segment_id", "cache_audit_previous_sealed_segment_tail_sha256",
        "cache_audit_signer_principal_id", "cache_audit_signer_key_id",
        "cache_audit_maximum_record_bytes", "cache_audit_maximum_log_bytes",
        "cache_audit_maximum_records", "cache_audit_rotation_policy",
    }
