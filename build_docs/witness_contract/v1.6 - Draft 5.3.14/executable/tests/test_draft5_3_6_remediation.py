...
class ApiConformanceTests(unittest.TestCase):
    ...
    class Authority:
        def __init__(self, witness):
            self.witness = witness; self.calls = 0; self.signing_key = Ed25519PrivateKey.generate()
        ...
        def verify(self, **arguments):
            ...
            result.update({
                ...
                "claim_content_sha256": authority.sha256_bytes(authority.canonical_bytes(arguments["canonical_claim"])),
                "theorem_statement_sha256": authority.sha256_bytes(arguments["theorem_statement"].encode("utf-8")),
                ...
                "policy_decision_id": arguments["policy_decision_id"], "policy_decision_sha256": arguments["policy_decision_sha256"],
    ...
    def test_openapi_response_matches_running_wsgi_adapter_and_idempotency(self):
        ...
        witness.update({
            "semantic_witness_content_id":"lean-semantic:"+"5"*64,
            "execution_evidence_content_id":"lean-execution:"+"6"*64,
