# Corpus Index v1.6 Draft 3

**Status:** Research specification draft  
**Version:** corpus-index@v1.6-draft-3  
**Document kind:** Corpus index  
**Primary purpose:** Provide a human-readable index to the v1.6 Draft 3 corpus.  
**Draft:** v1.6 Draft 3  
