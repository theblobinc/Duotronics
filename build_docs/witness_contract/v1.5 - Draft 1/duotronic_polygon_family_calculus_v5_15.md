# Duotronic Polygon Family Calculus (DPFC v5.15)

**Status:** Research specification draft  
**Version:** 5.15-standalone-revision  
**Supersedes:** DPFC v5.14
**Prior supersedes:** DPFC v5.13
**Prior supersedes:** DPFC v5.12
...
DPFC v5.15 defines the mathematical and representational layer of Duotronics.
...
DPFC v5.15 does not claim that:
...
DPFC v5.15 adopts `refs/duotronic_glossary_v1_0.md` for shared terms.
...
## 14. Draft 3 internal-decision boundary

> **Status tag:** reference

DPFC v5.15 remains the representational core. Draft 3 adds self-evidence, lookup memory, planning, and model-diversity governance to the corpus, but those additions do not redefine DPFC arithmetic, family value, canonical family identity, export policy, or bridge semantics.

A planner may choose to search, convert, query memory, or request a profile-learning run. Those actions are governed by the Witness Contract, Internal Decision and Planning Contract, and Policy Shield. They do not change DPFC semantics.

Chronological evidence may support learned profiles or preferences. It does not become a DPFC family unless a promoted profile is handed off through the Profile Synthesis Registry and Family Registry.


---

## 15. Draft 4 implementation-safety note

> **Status tag:** reference

Draft 4 addresses cross-cutting implementation concerns around self-informing loops, action conflicts, planner-triggered profile learning, policy-change proposals, self-model invalidation, multi-actor scope, and resource budgets.

These additions do not change DPFC core semantics. They clarify how systems using DPFC-linked representations can safely operate in larger autonomous or semi-autonomous runtime contexts.

DPFC-linked profile learning may be triggered by a planner, but the resulting profile remains a candidate until the Profile Synthesis Registry, Family Registry, Witness Contract, and Policy Shield all permit promotion.
