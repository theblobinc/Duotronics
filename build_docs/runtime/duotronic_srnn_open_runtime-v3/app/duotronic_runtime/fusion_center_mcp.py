...
def fusion_tool_manifest() -> list[dict[str, Any]]:
    return [
        ...
        {"name": "fusion.check_ioc", "description": "Look up an indicator of compromise in AlienVault OTX.", "read_only": True, "input_schema": _obj(["indicator"], {"indicator": {"type": "string", "minLength": 1}, "indicator_type": {"type": "string", "enum": ["IPv4", "IPv6", "domain", "hostname", "URL", "FileHash-MD5", "FileHash-SHA1", "FileHash-SHA256", "CVE", "email"], "default": "IPv4"}})},
