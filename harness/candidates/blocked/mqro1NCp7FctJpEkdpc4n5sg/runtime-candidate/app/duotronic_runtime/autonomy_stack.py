...
from .duotronic_bijective import (
    REFERENCE_SHA256 as BIJECTIVE_REFERENCE_SHA256,
...
CONTRACT_REF = "Witness Contract v1.6 Draft 5.3.16"
CONTRACT_PATH = "build_docs/witness_contract/v1.6 - Draft 5.3.16"
...
VENDOR_PROVENANCE: dict[str, dict[str, str]] = {
    "SceneProof": {
        ...
        "license_sha256": "572d3a5d46a790e5caa2a52107b0fb9829a87fe5a58f61b152e186a098150566",
    },
    "cognicore-my-openenv": {
        ...
        "license_sha256": "1fda5c1f38609c91d4ef26aeb1e5e0767c9ae0f17f7740cb764b53ec219d679e",
    },
    "truthmark": {
        "origin": "https://github.com/merlinhu1/truthmark",
        "commit": "5050eb0fb7829c974d4cfc8daecb888f44ef8747",
        "license_sha256": "3b511f5a6aec6c68ab6f1b217a1e33f2d311d13137efc01c3485fa1ec87983ec",
    },
    "forge": {
        "origin": "https://github.com/ForgeAILab/forge",
        "commit": "a3cf8deb06c92d4df9b672122f791fc0913dd8d3",
        "license_sha256": "7954f1ecfbd861b92c7b91d9d542c1cda02d5d86c0e5edcf6e9c3978d872acd2",
    },
    "argentos-core": {
        "origin": "https://github.com/ArgentAIOS/argentos-core",
        "commit": "acbf92944b9748c74691808953f580f1cd1fee9a",
        "license_sha256": "8d9e8a72e6c0f2833775f58d5849bacbf23b4a4071a9a7ece3e7773cb0f6863f",
    },
    "LoongFlow": {
...
class AutonomyStack:
    ...
    def provenance(self) -> dict[str, Any]:
        return {
            ...
            "duotronic_bijective_reference_sha256": BIJECTIVE_REFERENCE_SHA256,
        ...
        *,
        ...
        if training_eligible and event_type != "wgrnn_chat_turn":
            try:
                ...
                if redaction_info:
                    # Never copy potentially sensitive redacted payload material
                    # into broader recurrent state; learn only its witnessed event
                    # identity and digest.
                    observed = {
                        "session_id": session_id,
                        "event_type": event_type,
                ...
                recurrent_learning = self.kernel.wgrnn.step(
                    ...
                    user_id=f"conversation-source:{str(payload.get('conversation_source') or 'runtime')[:80]}",
                    agent_id=str(payload.get("agent_id") or actor or "self")[:256],
                    thread_id=(f"conversation:{str(payload.get('conversation_id'))[:256]}" if payload.get("conversation_id") else f"session:{session_id}"),
                    tags=[
