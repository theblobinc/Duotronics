# Draft 5.2 Complete Manifest

Scope: Draft 5.2 completion candidate with logical observer kernel and TLA+-only formal toolchain integration.

Excluded self-referential artifacts:

- `PACKAGE_INVENTORY_v1_6_draft_5_2.json`
- `PACKAGE_METADATA_v1_6_draft_5_2.json`
- `refs/manifest/CHECKSUMS_v1_6_draft_5_2.shake256_512`
...
- `formal/tlaplus/EvidenceClaimGraph.tla` / `.cfg`
- `formal/tlaplus/TaskDelegationAndPolicyCoreSpec.tla` / `.cfg`
- `formal/tlaplus/NonCollapseRuntime.tla` / `.cfg`
- `formal/tlaplus/LogicalObserverKernel.tla` / `.cfg`
...
- `refs/manifest/CHECKSUMS_v1_6_draft_5_1.shake256_512`
- `refs/manifest/CHECKSUMS_v1_6_draft_5_2.shake256_512`
