...
def HasExternalWitness (w : TransitionWitness) : Prop :=
  w.externalWitnessRef ≠ "" ∧ w.policyDecisionRef ≠ ""

def HasTransitionProofWitness (w : TransitionWitness) : Prop := w.proofWitnessRef.isSome
