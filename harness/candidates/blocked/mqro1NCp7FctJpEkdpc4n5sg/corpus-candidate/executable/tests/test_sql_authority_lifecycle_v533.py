...
class AuthorityDatabase533:
    def __init__(self):
        ...
        self.verifier_private = MLDSA87PrivateKey.generate()
        self.claim_hash = "a" * 128
        self.theorem_hash = "b" * 128
        self.artifact_hash = "c" * 128
        ...
        self._insert_claim(
            "claim:governance", "policy_decision", '{"action":"authority"}', "1" * 128,
    ...
    def register_verifier(self, suffix="1", valid_from="2020-01-01T00:00:00Z", valid_until="2099-01-01T00:00:00Z", activate=True):
        private = self.verifier_private if suffix == "1" else MLDSA87PrivateKey.generate()
        ...
        self.connection.execute(
            ...
            (verifier, "verifier_principal/v2", key, "ML-DSA-87", fingerprint, "active", valid_from, valid_until, valid_from),
        )
        self.connection.execute(
            "INSERT INTO wc_verifier_keys_v3 VALUES (?,?,?,?,?,?,?,?,?)",
            (key, "verifier_key/v3", verifier, "ML-DSA-87", authority.public_key_raw_b64url(public), fingerprint, valid_from, valid_until, valid_from),
        )
        if activate:
    ...
    def insert_authorization(self, action_type, target_type, target_id, authorization_id, *, tamper=False):
        ...
        self.connection.execute(
            ...
            (
                ...
                record["governance_key_id"], canonical, record["signed_payload_shake256_512"], record["signature"], record["created_at"],
            ),
        )
    ...
    def insert_key_event(self, *, key, status, event_id, authorization, effective_at, recorded_at, replacement=None, reason="lifecycle action", tamper=False):
        ...
        self.connection.execute(
            ...
            (
                ...
                canonical, record["signed_payload_shake256_512"], record["signature"],
            ),
        )
    ...
    def insert_chain(self, *, hermetic=True):
        ...
        compiler_unsigned = {
            ...
            "claim_content_shake256_512": self.claim_hash, "theorem_statement_shake256_512": self.theorem_hash, "proof_artifact_shake256_512": self.artifact_hash,
            "proof_artifact_relative_path": "Proof.lean", "proof_module": "Proof", "source_tree_shake256_512": "d" * 128,
            "original_source_tree_shake256_512": "d" * 128, "immutable_snapshot_shake256_512": "d" * 128, "lakefile_shake256_512": "e" * 128,
            "generated_witness_module_shake256_512": "9" * 128, "generated_witness_module_path": ".witness_authority/Check_0123456789abcdef0123456789abcdef.lean",
            "exact_build_target": ".witness_authority/Check_0123456789abcdef0123456789abcdef.lean", "compiler_profile_id": "profile:1",
            "compiler_registry_shake256_512": "7" * 128, "lake_executable_shake256_512": "2" * 128, "lean_executable_shake256_512": "3" * 128,
            "lean_stdlib_tree_shake256_512": "4" * 128, "dependency_closure_shake256_512": "5" * 128, "execution_image_digest": "shake256-512:" + "1" * 128,
            "sandbox_policy_shake256_512": "6" * 128, "verifier_binary_shake256_512": "8" * 128, "compiler_executable_shake256_512": "3" * 128,
            "structured_result_shake256_512": "a" * 128, "build_output_shake256_512": "f" * 128, "toolchain": "leanprover/lean4:v4.29.1",
            ...
            "verifier_principal_id": verifier, "key_id": key, "signature_algorithm": "ML-DSA-87",
        ...
        columns = [
            "lean_compiler_witness_id", "schema_version", "claim_id", "claim_content_shake256_512", "theorem_statement_shake256_512", "proof_artifact_shake256_512",
            "source_tree_shake256_512", "lakefile_shake256_512", "build_output_shake256_512", "toolchain", "command_json", "execution_mode", "result", "contains_sorry",
            "contains_admit", "unapproved_axiom_count", "theorem_name", "theorem_status", "verifier_principal_id", "key_id", "signature_algorithm",
            "signed_payload_shake256_512", "signature", "created_at", "proof_artifact_relative_path", "proof_module", "generated_witness_module_shake256_512",
            "generated_witness_module_path", "exact_build_target", "compiler_executable_shake256_512", "axiom_dependencies_json", "axiom_inspection_complete",
            "statement_binding_confirmed", "warnings_as_errors", "original_source_tree_shake256_512", "immutable_snapshot_shake256_512", "compiler_profile_id",
            "compiler_registry_shake256_512", "lake_executable_shake256_512", "lean_executable_shake256_512", "lean_stdlib_tree_shake256_512", "dependency_closure_shake256_512",
            "execution_image_digest", "sandbox_policy_shake256_512", "verifier_binary_shake256_512", "structured_result_shake256_512", "snapshot_verified_immutable",
        ...
        self.connection.execute(
            ...
            ("sigbind:compiler:legacy-fields", "authority_signature_binding/v1", "lean_compiler_witness", "lean:533", key, authority.signed_payload_canonical_json(compiler), compiler["signed_payload_shake256_512"], self.proof_time),
        )
        self.connection.execute(
            "INSERT INTO wc_authority_signature_bindings_v2 VALUES (?,?,?,?,?,?,?,?)",
            ("sigbind:compiler:533", "authority_signature_binding/v2", "lean_compiler_witness_5_3_3", "lean:533", key, authority.signed_payload_canonical_json(compiler), compiler["signed_payload_shake256_512"], self.proof_time),
        )
        proof_unsigned = {
            "schema_version": "proof_witness/v2", "proof_witness_id": "proof:533", "claim_id": "claim:proof",
            "claim_content_shake256_512": self.claim_hash, "theorem_statement_shake256_512": self.theorem_hash,
            "proof_artifact_shake256_512": self.artifact_hash, "lean_compiler_witness_id": "lean:533", "theorem_name": "promotion_sound",
        ...
        self.connection.execute(
            "INSERT INTO wc_proof_witnesses_v2 (proof_witness_id,schema_version,claim_id,claim_content_shake256_512,theorem_statement_shake256_512,proof_artifact_shake256_512,lean_compiler_witness_id,theorem_name,theorem_status,policy_decision_id,verifier_principal_id,signed_payload_shake256_512,signature,created_at,key_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
            tuple(proof[name] for name in ("proof_witness_id", "schema_version", "claim_id", "claim_content_shake256_512", "theorem_statement_shake256_512", "proof_artifact_shake256_512", "lean_compiler_witness_id", "theorem_name", "theorem_status", "policy_decision_id", "verifier_principal_id", "signed_payload_shake256_512", "signature", "created_at", "key_id")),
        )
        self.connection.execute(
            "INSERT INTO wc_authority_signature_bindings_v1 VALUES (?,?,?,?,?,?,?,?)",
            ("sigbind:proof:533", "authority_signature_binding/v1", "proof_witness", "proof:533", key, authority.signed_payload_canonical_json(proof), proof["signed_payload_shake256_512"], self.proof_time),
        )
    ...
    def insert_gate(self, gate_id="gate:533"):
        self.connection.execute(
            "INSERT INTO wc_theorem_promotion_gates_v2 (theorem_promotion_gate_id,schema_version,claim_id,claim_content_shake256_512,theorem_statement_shake256_512,status_event_id,proof_witness_id,lean_compiler_witness_id,non_collapse_transition_id,policy_decision_id,verifier_principal_id,allowed,rejection_reason,created_at,key_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
...
class SqlAuthorityLifecycle533Tests(unittest.TestCase):
    ...
    def test_nonhermetic_compiler_cannot_create_gate(self):
        db = self.database(); db.insert_chain(hermetic=False)
        expect_integrity_error(self, db.insert_gate)

    def test_unsigned_or_tampered_key_event_is_rejected(self):
        db = self.database(); db.register_verifier(activate=False)
    ...
    def test_revoked_key_cannot_create_gate(self):
        db = self.database(); db.insert_chain()
    ...
    def test_lifecycle_and_snapshot_tables_are_append_only(self):
        db = self.database(); db.register_verifier(); db.insert_snapshot("snapshot:1", "2026-07-31T12:00:00Z")
    ...
    def test_compiler_signature_binding_covers_lean_digest(self):
        db = self.database(); db.register_verifier()
        # A full chain is signed and accepted; after insert, compiler records are append-only.
        db = self.database(); db.insert_chain()
        expect_integrity_error(self, lambda: db.connection.execute("UPDATE wc_lean_compiler_witnesses_v2 SET lean_executable_shake256_512=? WHERE lean_compiler_witness_id='lean:533'", ("0" * 128,)))
