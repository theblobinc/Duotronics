...
CHECKSUMS = "refs/manifest/CHECKSUMS_v1_6_draft_5_3_1.shake256_512"
...
def main() -> int:
    paths = files()
    records = []
    checksum_lines = ["# SHAKE256-512 closure for Duotronic Witness Contract v1.6 Draft 5.3.1", "# Generated artifacts named in the inventory are intentionally excluded from recursive closure."]
    extensions = Counter()
    for path in paths:
    ...
    inventory = {
        ...
        "base_package_shake256_512": "437395d28c452f0a20937eaf562020afae2214edf01a8df2fe6dadd062201c22",
    ...
    manifest_lines.extend(["", "## Hash exclusion", "", "The inventory, checksum file, this human manifest, and the validator report are generated artifacts excluded from their own recursive hash closure. Every other file is SHAKE256-512 covered.", ""])
