...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_14.json", "CHECKSUMS_v1_6_draft_5_3_14.shake256_512"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_14.shake256_512").read_text(encoding="utf-8").splitlines()
...
def phase_python_version_portability() -> dict[str, Any]:
    ...
    assert_true(generated.get("python_matrix_shake256_512") == shake256_512(ROOT / "DRAFT5_3_14_PYTHON_MATRIX_VALIDATION.json"), "regression record does not bind the Python matrix")
    for item in runs:
...
def phase_standalone_merged_corpus() -> dict[str, Any]:
    ...
    assert_true(
        ...
        and releases[-1].get("shake256_512") == "6b9229cd3d463053328bed84ce59585638b74bd6e2193667e48af6863305f733",
