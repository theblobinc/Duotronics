#!/usr/bin/env python3
"""Generate the complete lifecycle-classified Draft 5.3.12 schema registry."""
...
OUTPUT = ROOT / "refs/schema_registry_v1_6_draft_5_3_12.json"
...
CANONICAL = {
    ...
    "cache_stale_row_evidence_v2", "domain_execution_evidence_v1",
...
def main() -> int:
    ...
    for path in schema_paths:
        ...
        if name in CANONICAL:
            lifecycle = "canonical"; active = True; rationale = "Active Draft 5.3.12 API, persistence, witness, or validation surface."
        elif name in LEGACY:
        ...
        runtime_valid = {
            ...
            "cache_stale_row_evidence_v2": "runtime:test_authenticated_predecessor_row_emits_evidence_then_returns_stable_conflict",
    ...
    registry = {
        ...
        "registry_version": "v1.6-draft-5.3.12", "active_version_scope": "v1.6-draft-5.3.12",
        "entries": entries,
        "rules": {
