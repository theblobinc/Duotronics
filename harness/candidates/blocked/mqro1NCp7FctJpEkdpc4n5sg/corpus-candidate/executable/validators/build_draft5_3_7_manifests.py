#!/usr/bin/env python3
"""Build final-byte provenance, inventory, checksum, and manifest for Draft 5.3.7."""
...
INVENTORY = "PACKAGE_INVENTORY_v1_6_draft_5_3_7.json"
CHECKSUMS = "refs/manifest/CHECKSUMS_v1_6_draft_5_3_7.shake256_512"
MANIFEST = "refs/manifest/MANIFEST_v1_6_draft_5_3_7_complete.md"
REPORT = "DRAFT5_3_7_VALIDATION_REPORT.json"
PROVENANCE = "PACKAGE_PROVENANCE_v1_6_draft_5_3_7.json"
REVIEW = "refs/review/v1.6_draft_5.3.7_update_checklist.md"
...
HISTORY = [
    ...
    ("v1.6 - Draft 5.3.1.zip", "26608233721f6b56ce6dfe653029c421e72a551196e004d2b2d3d59de588", 560),
...
def write_provenance() -> None:
    ...
    record = {
        ...
        "generator_version": "draft5_3_7_manifest_builder/v1",
        "generator_shake256_512": digest(ROOT / generator),
        "source_generation": "v1.6-draft-5.3.6",
        "base_revision": "v1.6-draft-5.3.6",
...
def main() -> int:
    ...
    records: list[dict] = []
    checksums = [
        "# SHAKE256-512 closure for Duotronic Witness Contract v1.6 Draft 5.3.7",
    ...
    inventory = {
        ...
        "package_version": "v1.6-draft-5.3.7",
        "package": "duotronic-witness-contract-v1.6-draft-5.3.7",
        ...
        "canonical_descriptor": "CANONICAL_CORPUS_v1_6_draft_5_3_7.json",
    ...
    lines = [
        "# Complete Manifest — Duotronic Witness Contract v1.6 Draft 5.3.7",
        "",
        ...
        "- Exact historical Draft 5.2.2 through 5.3.6 archives: retained and verified",
    ...
    lines.extend([
        ...
        "The active inventory, checksum file, this human manifest, and validation report recursively describe package closure. Their own inventory hash and size fields are null; every other final regular file is size- and SHAKE256-512-covered.",
        "", "## Documentation scope", "",
