...
AllowedStatusTransitions ==
  {<<"unknown", "absent">>, <<"unknown", "invalid">>, <<"unknown", "draft">>,
   <<"unknown", "observed">>, <<"draft", "observed">>, <<"observed", "computed">>,
   <<"computed", "proposed">>, <<"proposed", "asserted">>,
   <<"proposed", "deferred">>, <<"proposed", "vetoed">>,
   <<"asserted", "conjecture">>, <<"conjecture", "theorem">>,
   <<"theorem", "proof_verified">>, <<"proof_verified", "policy_approved">>,
   <<"policy_approved", "released">>}
...
Promote(c, source, target, policy, proofRef) ==
  ...
  /\ <<source, target>> \in AllowedStatusTransitions
