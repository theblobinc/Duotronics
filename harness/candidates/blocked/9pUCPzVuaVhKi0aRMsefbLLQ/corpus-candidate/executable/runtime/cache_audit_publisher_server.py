...
def load_publisher_server(config_root: Path) -> AuditPublisherServer:
    ...
    anchor_client = UnixSocketAuditAnchorClient(
        ...
        anchor_signing_registry_shake256_512=anchor_sha, anchor_registry_records=anchor_records,
    ...
    def sink_factory() -> SignedAppendOnlyAuditSink:
        return SignedAppendOnlyAuditSink(
            ...
            signer_principal_id=config["record_principal_id"], audit_signing_registry_shake256_512=record_sha,
    ...
    return AuditPublisherServer(
        ...
        receipt_signing_registry_shake256_512=receipt_sha, receipt_registry_records=receipt_records,
