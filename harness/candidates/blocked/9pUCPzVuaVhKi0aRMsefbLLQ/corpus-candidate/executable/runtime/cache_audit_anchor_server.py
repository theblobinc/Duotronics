...
def load_anchor_server(config_root: Path) -> AuditAnchorServer:
    ...
    registry_shake256_512, records, verification_keys = validate_governed_signing_registry(
    ...
    store = FileBackedMonotonicAnchorStore(
        ...
        anchor_registry_shake256_512=registry_shake256_512, anchor_registry_records=records,
