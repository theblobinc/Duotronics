...
def phase_descriptor() -> dict[str, Any]:
    ...
    for token in (DESCRIPTOR_PATH.name, "PACKAGE_INVENTORY_v1_6_draft_5_3_4.json", "CHECKSUMS_v1_6_draft_5_3_4.shake256_512"):
...
def phase_hash_closure() -> dict[str, Any]:
    ...
    checksum_lines = (ROOT / "refs/manifest/CHECKSUMS_v1_6_draft_5_3_4.shake256_512").read_text(encoding="utf-8").splitlines()
...
def phase_sql_migration() -> dict[str, Any]:
    ...
    hardening = {
        "semantic_witness_content_id", "immutable_snapshot_id", "immutable_snapshot_tree_shake256_512",
        "proof_artifact_relative_path", "proof_artifact_shake256_512", "generated_binding_module_shake256_512",
        "generated_binding_request_shake256_512", "compiler_profile_id", "verifier_result_payload_shake256_512",
        ...
        "actual_type_expression_hash", "axiom_set_shake256_512", "statement_binding_confirmed",
    ...
    profile_binding = {
        "oci_runtime_version", "lean_stdlib_tree_shake256_512", "verifier_source_revision",
        "verifier_build_attestation_id", "verifier_result_signer_key_id",
        "verifier_result_public_key_base64url", "valid_from", "valid_until",
        "governance_key_id", "signed_payload_canonical_json", "signed_payload_shake256_512", "signature",
    }
