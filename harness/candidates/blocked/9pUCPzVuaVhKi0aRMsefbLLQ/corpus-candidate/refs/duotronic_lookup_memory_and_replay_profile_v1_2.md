# Duotronic Lookup Memory And Replay Profile v1 2 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `refs/duotronic_lookup_memory_and_replay_profile_v1_2.md` from v1.5 Draft 2  
