# Manifest — Duotronic v1.6 Draft 3 RC Closure Corpus

Status: canonical manifest.

```yaml
bundle_id: duotronic_v1_6_draft_3_rc_closure_corpus
version: v1.6-draft-3-rc-closure
generated: 2026-04-30
format: markdown
manifest_directory: refs/manifest
markdown_file_count: 198
issues_addressed:
  - missing executable OpenAPI artifact
  - missing executable SQL migrations
  - missing formal model artifacts
  - live cognition step bug
  - missing Start Here guide
  - direct mutation tool enforcement
  - missing STRIDE threat model
  - polyglot stack justification
  - cognition loop boundary definition
  - migration and rollback plan
  - MCP recurrence conformance gaps
  - duplicate same-day v1.0/v1.1 document ambiguity
files:
