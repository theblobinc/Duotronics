# Duotronic Wgrnn Pytorch Skeleton v1 0 — v1.6 upgraded carry-forward

**Status:** upgraded carry-forward draft  
**Supersedes / carries forward:** `refs/examples/duotronic_wgrnn_pytorch_skeleton_v1_0.md` from v1.5 Draft 2  
