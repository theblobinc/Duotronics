...
async def complete_ollama_generate(settings: Settings, *, prompt: str, model: dict[str, Any], options: dict[str, Any] | None = None, messages: list[dict[str, str]] | None = None, timeout_seconds: float | None = None) -> dict[str, Any]:
