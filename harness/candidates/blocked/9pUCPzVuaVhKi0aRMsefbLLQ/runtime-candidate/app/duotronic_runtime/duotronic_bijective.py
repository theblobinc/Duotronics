...
Witness Contract v1.6 Draft 5.3.16:

  build_docs/witness_contract/v1.6 - Draft 5.3.16/
    executable/runtime/positive_baseline.py

Reference SHA-256 at integration time:
  725b721e26a946e9b5c33a0ea921847fff8bd2ecf3445edc7167a0045b5fd48d
...
REFERENCE_SHA256 = "725b721e26a946e9b5c33a0ea921847fff8bd2ecf3445edc7167a0045b5fd48d"
...
def bijective_encode(n: int, alphabet: Iterable[str] | None = None) -> tuple[str, ...]:
    ...
    This is behavior-compatible with Draft 5.3.16 positive_baseline.py.
    """
